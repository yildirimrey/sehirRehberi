...
namespace SehirRehberi.API.Controllers
{
    ...
    public class PhotosController : Controller
    {
        ...
        [HttpPost]
        //[Route("addPhoto")]
        public ActionResult AddPhotoForCity(int cityId, [FromForm] PhotoForCreationDto photoFotCreationDto)
        {
            var city = _appRepository.GetCity(cityId);
            if (city == null)
            {
            ...
            var file = photoFotCreationDto.File;
            ...
            photoFotCreationDto.Url = uploadResult.Uri.ToString();
            photoFotCreationDto.PublicId = uploadResult.PublicId;

            var photo = _mapper.Map<Photo>(photoFotCreationDto);
            photo.City = city;
